...
<section class="page_title">
    <div class="content_breadcump">
        ...
        <h1>{{ __('messages.sejour_breadcrumb') }}</h1>
    </div>
</section>
<section class="container">
    <div class="offer_details my-5">
        <span class="title_span">{{ __('messages.sejour_breadcrumb') }}</span>
        <div class="d-lg-flex d-block align-items-center justify-content-between mt-4">
            <h2 class=" mb-lg-0 mb-3 offer__nm">{{ __('messages.sejour_title') }}</h2>
            <div>
            ...
            <div class="swiper offer_swiper">
                <div class="swiper-wrapper">
                    <a class="swiper-slide activity_slide" data-fancybox="offer-gallery" href="assets/images/DesertNightDakhlaBivouacImlili.jpeg">
                        <img loading="lazy" src="assets/images/DesertNightDakhlaBivouacImlili.jpeg" alt="Séjour Désert Dakhla">
                        <span class="activity_label">Séjour Désert</span>
                    </a>
                    <a class="swiper-slide activity_slide" data-fancybox="offer-gallery" href="assets/images/experince4.jpeg">
                        <img loading="lazy" src="assets/images/experince4.jpeg" alt="Séjour Désert Dakhla">
                        <span class="activity_label">Séjour Désert</span>
                    </a>
                    <a class="swiper-slide activity_slide" data-fancybox="offer-gallery" href="assets/images/experince9.jpeg">
                        <img loading="lazy" src="assets/images/experince9.jpeg" alt="Séjour Désert Dakhla">
                        <span class="activity_label">Séjour Désert</span>
                    </a>
                    <a class="swiper-slide activity_slide" data-fancybox="offer-gallery" href="assets/images/experince10.jpeg">
                        <img loading="lazy" src="assets/images/experince10.jpeg" alt="Séjour Désert Dakhla">
                        <span class="activity_label">Séjour Désert</span>
                    </a>
                </div>
            </div>
        ...
        <div class="mt-4">
            <h3>{{ __('messages.sejour_program') }}</h3>
            <p class="cr_color">{{ __('messages.sejour_description') }}</p>
        </div>
            ...
            <div class="col-lg-8  col-12">
                <div class="border__cnt">
                    <div class="d-flex align-items-center justify-content-between iteme gap-4 border___botom">
                        ...
                        <div class="text-end">
                            <span class="detail_img">{{ __('messages.sejour_location') }}</span>
                        </div>
                    </div>
                    <div class="d-flex align-items-center justify-content-between iteme gap-4 border___botom">
                        <div class="d-flex align-items-center gap-2">
                        ...
                        <div class="text-end">
                            <span class="detail_img">{{ __('messages.sejour_duration') }}</span>
                        </div>
                    </div>
                    <div class="d-flex align-items-center justify-content-between iteme gap-4">
                        ...
                        <div class="text-end">
                            <span class="detail_img">{{ __('messages.sejour_transport') }}</span>
                        </div>
                    </div>
                </div>
                <div class="my-4">
                    ...
                    <div class="border__cnt mb-3">
                        <div class="dropdown_item">
                            <div class="d-flex align-items-center justify-content-between iteme iteme_drop_">
                                <div class="d-flex align-items-center gap-2">
                                    <img loading="lazy" src="assets/images/location.svg" alt="">
                                    <span class="img_title">{{ __('messages.sejour_jour1_title') }}</span>
                                </div>
                                <div class="gap__drop">
                                    <span class="detail_img">{{ __('messages.sejour_jour1_time') }}</span>
                                    <img loading="lazy" src="assets/images/dropdownn.svg" alt="">
                                </div>
                            </div>
                            <div class="mt-3 description" style="display: none;">
                                <p class="cr_color">{{ __('messages.sejour_jour1_desc') }}</p>
                            </div>
                        </div>
                    </div>
                    <div class="border__cnt mb-3">
                        <div class="dropdown_item">
                            <div class="d-flex align-items-center justify-content-between iteme iteme_drop_">
                                <div class="d-flex align-items-center gap-2">
                                    <img loading="lazy" src="assets/images/location.svg" alt="">
                                    <span class="img_title">{{ __('messages.sejour_jour2_title') }}</span>
                                </div>
                                <div class="gap__drop">
                                    <img loading="lazy" src="assets/images/dropdownn.svg" alt="">
                                </div>
                            ...
                            <div class="mt-3 description" style="display: none;">
                                <p class="cr_color">{{ __('messages.sejour_jour2_desc') }}</p>
                            </div>
                        </div>
                    </div>
                    <div class="border__cnt mb-3">
                        <div class="dropdown_item">
                            <div class="d-flex align-items-center justify-content-between iteme iteme_drop_">
                                <div class="d-flex align-items-center gap-2">
                                    <img loading="lazy" src="assets/images/location.svg" alt="">
                                    <span class="img_title">{{ __('messages.sejour_jour3_title') }}</span>
                                </div>
                                <div class="gap__drop">
                                    <img loading="lazy" src="assets/images/dropdownn.svg" alt="">
                                </div>
                            ...
                            <div class="mt-3 description" style="display: none;">
                                <p class="cr_color">{{ __('messages.sejour_jour3_desc') }}</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="book_cnt ">
                    <form class="offer__bk" action="{{ route('reservation.store') }}" method="post">
                        ...
                        <div class="d-flex mb-3 align-items-center justify-content-between">
                            <span class="price_span">{{ __('messages.sejour_price') }}</span>
                            <input type="hidden" name="prix" value="000">
                            <input type="hidden" name="name" class="hide__ofnm" value="">
                            <input type="hidden" name="img_src" value="assets/images/DesertNightDakhlaBivouacImlili.jpeg">
                        </div>
