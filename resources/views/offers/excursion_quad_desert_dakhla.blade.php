...
<section class="container">
    <div class="offer_details my-5">
        ...
        <div class="d-lg-flex d-block align-items-center justify-content-between mt-4">
            <h2 class=" mb-lg-0 mb-3 offer__nm">{{ __('messages.key_e380a8ce82dc9aeee8d9a27c779e4eb7') }}
            </h2>
            <div>
        ...
        <div class="offer_swiper_wrapper mt-3">
            <div class="swiper offer_swiper">
                <div class="swiper-wrapper">
                    <a class="swiper-slide activity_slide" data-fancybox="offer-gallery" href="assets/images/Frame737821438.png">
                        <img loading="lazy" src="assets/images/Frame737821438.png" alt="">
                        <span class="activity_label">Quad Desert</span>
                    </a>
                    <a class="swiper-slide activity_slide" data-fancybox="offer-gallery" href="assets/images/Frame 73214444.png">
                        <img loading="lazy" src="assets/images/Frame 73214444.png" alt="">
                        <span class="activity_label">Quad Desert</span>
                    </a>
                    <a class="swiper-slide activity_slide" data-fancybox="offer-gallery" href="assets/images/Frame9821441.png">
                        <img loading="lazy" src="assets/images/Frame9821441.png" alt="">
                        <span class="activity_label">Quad Desert</span>
                    </a>
                </div>
            </div>
        ...
        <div class="mt-4">
            ...
            <p class="cr_color">{{ __('messages.key_c3e97a8455b01f3299c5efef52529a59') }}           
            </p>
        </div>
                ...
                <div class="">
                        ...
                        <div class="dropdown_item">
                            <div class="d-flex align-items-center justify-content-between iteme iteme_drop_">
                                <div class="d-flex align-items-center gap-2">
                                    <span class="img_title">{{ __('messages.key_8f45244e6f1e0cee393e23215a2d58e4') }}</span>
                                </div>
                                <div class="gap__drop">
                                    <span class="detail_img">{{ __('messages.key_7fd5c7a0ddf629f7482e50466ffcb91a') }}</span>
                                    <img loading="lazy" src="assets/images/dropdownn.svg" alt="">
                                </div>
                            </div>
                            <div class="mt-3 description" style="display: none;">
                                <p class="cr_color">{{ __('messages.key_55abab05ab09028301b49710b80575d7') }}
                                </p> 
                            </div>
                        </div>
                    </div>
                    <div class="border__cnt mb-3">
                        <div class="dropdown_item">
                            <div class="d-flex align-items-center justify-content-between iteme iteme_drop_">
                                <div class="d-flex align-items-center gap-2">
                                    <span class="img_title">{{ __('messages.key_5c3d0750f2a6f06b34eb45ae702980bf') }}</span>
                                </div>
                                <div class="gap__drop">
                                    <span class="detail_img">{{ __('messages.key_83f07d93c785b61030e1d2faf6b917a3') }}</span>
                                    <img loading="lazy" src="assets/images/dropdownn.svg" alt="">
                                </div>
                            </div>
                            <div class="mt-3 description" style="display: none;">
                                <p class="cr_color">{{ __('messages.key_f7840c6130a91d2a1f54b4fdb4a17da8') }}
                                </p> 
                            </div>
                        </div>
                    </div>
                    <div class="border__cnt mb-3">
                        <div class="dropdown_item">
                            <div class="d-flex align-items-center justify-content-between iteme iteme_drop_">
                                <div class="d-flex align-items-center gap-2">
                                    <span class="img_title">{{ __('messages.key_1d13c2dbf5308a73cf109d3272c0ee55') }}</span>
                                </div>
                                <div class="gap__drop">
                                    <span class="detail_img">{{ __('messages.key_295030b84289d37aa125f03252f6ee11') }}</span>
                                    <img loading="lazy" src="assets/images/dropdownn.svg" alt="">
                                </div>
                            </div>
                            <div class="mt-3 description" style="display: none;">
                                <p class="cr_color">{{ __('messages.key_f87ed017680378e57b08346713b8a66d') }}
                                </p> 
                            </div>
                        </div>
                    </div>
                ...
                <div class="">
                    <div class="border__cnt  mb-3">
                        <div class="dropdown_item">
                            <div class="d-flex align-items-center justify-content-between iteme iteme_drop_">
                                <div class="d-flex align-items-center gap-2">
                                    <span class="img_title">{{ __('messages.key_9c1b0b873d55245c9e1f9194f9c14b7b') }}</span>
                                </div>
                    ...
                    <div class="border__cnt  mb-3">
                        <div class="dropdown_item">
                            <div class="d-flex align-items-center justify-content-between iteme iteme_drop_">
                                <div class="d-flex align-items-center gap-2">
                                    <span class="img_title">{{ __('messages.key_5db9885481ffc861fd693f7d7fc7ae18') }}</span>
                                </div>
                    ...
                    <div class="border__cnt  mb-3">
                        <div class="dropdown_item">
                            <div class="d-flex align-items-center justify-content-between iteme iteme_drop_">
                                <div class="d-flex align-items-center gap-2">
                                    <span class="img_title">{{ __('messages.key_9946c32d0455fcd5730391e3ba775bdd') }}</span>
                                </div>
                ...
                <div class="book_cnt ">
                    <form class="offer__bk" action="{{ route('reservation.store') }}" method="post">
                        ...
                        <div class="d-flex mb-3 align-items-center justify-content-between">
                            ...
                            <input type="hidden" name="img_src" value="assets/images/Frame737821438.png">
                        </div>
                        <p class="cr_color">Les prix varient selon l’option choisie et la durée de l’excursion.
                        </p>
