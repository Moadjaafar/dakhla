    ...
    <div class="offer_details my-5">
        ...
        <div class="row w-100 mt-3 mx-auto">
            <div class="col-lg-8 col-md-8 col-12">
                <img src="assets/images/Frame42186438.png" class="w-100 h-100 top_image" alt="">
            </div>
            <div class="col-lg-4 col-md-4 col-12 d-lg-block d-md-block d-flex gap-lg-0 gap-md-0">
                <img src="assets/images/Frame3214.png" class="w-lg-100 w-md-100 w-sm-50 bottom_right" alt="">
                <img src="assets/images/Frame7367441.png" class="w-lg-100 w-md-100 w-sm-50 bottom_left  mt-lg-3 mt-md-3" alt="">
            </div>
        </div>
        <div class="mt-4">
