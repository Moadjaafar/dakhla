...
<section class="container">
    <div class="offer_details my-5">
        ...
        <div class="d-lg-flex d-block align-items-center justify-content-between mt-4">
            <h2 class=" mb-lg-0 mb-3 offer__nm">{{ __('messages.key_e5b8d86eb0ce9537f6d9f9dd5400a15e') }}
            </h2>
            <div>
        ...
        <div class="offer_swiper_wrapper mt-3">
            <div class="swiper offer_swiper">
                <div class="swiper-wrapper">
                    <a class="swiper-slide activity_slide" data-fancybox="offer-gallery" href="assets/images/Frame427321438.png">
                        <img loading="lazy" src="assets/images/Frame427321438.png" alt="">
                        <span class="activity_label">Excursion Demi Journée</span>
                    </a>
                    <a class="swiper-slide activity_slide" data-fancybox="offer-gallery" href="assets/images/Frame427321440.png">
                        <img loading="lazy" src="assets/images/Frame427321440.png" alt="">
                        <span class="activity_label">Excursion Demi Journée</span>
                    </a>
                    <a class="swiper-slide activity_slide" data-fancybox="offer-gallery" href="assets/images/Frame427321441.png">
                        <img loading="lazy" src="assets/images/Frame427321441.png" alt="">
                        <span class="activity_label">Excursion Demi Journée</span>
                    </a>
                </div>
            </div>
        ...
        <div class="mt-4">
            ...
            <p class="cr_color">{{ __('messages.key_12d2cb0c1a9f6dfc9c5fe7fa3e9faf03') }}</p>
        </div>
            ...
            <div class="col-lg-8  col-12">
                <div class="border__cnt">
                    ...
                    <div class="d-flex align-items-center justify-content-between iteme gap-4 border___botom">
                        ...
                        <div class="text-end">
                            <span class="detail_img">{{ __('messages.key_2ce5155c00833436d77f617334c1290e') }}</span>
                        </div>
                    </div>
                    ...
                    <div class="border__cnt mb-3">
                        <div class="dropdown_item">
                            <div class="d-flex align-items-center justify-content-between iteme iteme_drop_">
                                <div class="d-flex align-items-center gap-2">
                                    <img loading="lazy" src="assets/images/location.svg" alt="">
                                    <span class="img_title">{{ __('messages.key_1c2d029b07fa35a4b8aec4dd7510ce2b') }}</span>
                                </div>
                                <div class="gap__drop">
                            ...
                            <div class="mt-3 description" style="display: none;">
                                ...
                                <h3 class="">{{ __('messages.key_6cdc19158f2c27bce300aaab06ec930d') }}</h3>
                                <p class="cr_color">{{ __('messages.key_2099c3f0ce05b9841a1b8ef160a90c8b') }}</p>
                                <h3 class="">{{ __('messages.key_7515f9c0527f36792d8659e957427669') }}</h3>
                                <p class="cr_color">{{ __('messages.key_e8d565304543acc932b8d0274fbd176a') }}</p>
                                <h3 class="">{{ __('messages.key_9623534963f8e7e058cae58b7834dc71') }}</h3>
                                <p class="cr_color">{{ __('messages.key_61042a4e21c4f2912c46a3a527ee2936') }}</p>
                            </div>
                        </div>
                    </div>
                    <div class="border__cnt  mb-3">
                        <div class="dropdown_item">
                            <div class="d-flex align-items-center justify-content-between iteme iteme_drop_">
                                <div class="d-flex align-items-center gap-2">
                                    <img loading="lazy" src="assets/images/location.svg" alt="">
                                    <span class="img_title">{{ __('messages.key_b8a5dbac4a13800eadbb230dbd7755e6') }}</span>
                                </div>
                                <div class="gap__drop">
                            ...
                            <div class="mt-3 description" style="display: none;">
                                <p class="cr_color">{{ __('messages.key_58040be161b9d25570bf796d9639a086') }}</p>
                                <ul>
                                    <li>{{ __('messages.key_af8073ffd70575d44e997ff7c280cb27') }}</li>
                                    <li>{{ __('messages.key_269271f683027ba00e1762f13dc1220d') }}</li>
                                    <li>{{ __('messages.key_2b1872132e2cd6a941e2b13693069631') }}</li>
                                </ul>
                            </div>
                        </div> 
                    </div>
                ...
                <div class="book_cnt ">
                    <form class="offer__bk" action="{{ route('reservation.store') }}" method="post">
                        ...
                        <div class="d-flex mb-3 align-items-center justify-content-between">
                            <span class="price_span">90 €</span>
                            <span class="price_tag">Tarif</span>
                            <input type="hidden" name="prix" value="900">
                            <input type="hidden" name="name" class="hide__ofnm" value="">
                            <input type="hidden" name="img_src" value="assets/images/Frame427321440.png">
                        </div>
