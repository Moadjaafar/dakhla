...
<section class="page_title">
    <div class="content_breadcump">
        ...
        <h1>{{ __('messages.whitedune_breadcrumb') }}</h1>
    </div>
</section>
<section class="container">
    <div class="offer_details my-5">
        <span class="title_span">{{ __('messages.whitedune_breadcrumb') }}</span>
        <div class="d-lg-flex d-block align-items-center justify-content-between mt-4">
            <h2 class=" mb-lg-0 mb-3 offer__nm">{{ __('messages.whitedune_title') }}</h2>
            <div>
        ...
        <div class="mt-4">
            <h3>{{ __('messages.whitedune_program') }}</h3>
            <p class="cr_color">{{ __('messages.whitedune_description') }}</p>
        </div>
            ...
            <div class="col-lg-8  col-12">
                <div class="border__cnt">
                    <div class="d-flex align-items-center justify-content-between iteme gap-4 border___botom">
                        ...
                        <div class="text-end">
                            <span class="detail_img">{{ __('messages.whitedune_location') }}</span>
                        </div>
                    </div>
                    <div class="d-flex align-items-center justify-content-between iteme gap-4 border___botom">
                        <div class="d-flex align-items-center gap-2">
                        ...
                        <div class="text-end">
                            <span class="detail_img">{{ __('messages.whitedune_duration') }}</span>
                        </div>
                    </div>
                    <div class="d-flex align-items-center justify-content-between iteme gap-4 border___botom">
                        <div class="d-flex align-items-center gap-2">
                        ...
                        <div class="text-end">
                            <span class="detail_img">{{ __('messages.whitedune_transport') }}</span>
                        </div>
                    </div>
                    <div class="d-flex align-items-center justify-content-between iteme gap-4">
                        ...
                        <div class="text-end">
                            <span class="detail_img">{{ __('messages.whitedune_group') }}</span>
                        </div>
                    </div>
                </div>
                <div class="my-4">
                    <h3>{{ __('messages.whitedune_details_title') }}</h3>
                    <p class="cr_color">{{ __('messages.whitedune_details_desc') }}</p>
                </div>
                <div class="border__cnt mb-3">
                    <div class="d-flex align-items-start gap-2 p-3">
                        <span class="note_repas w-100">{{ __('messages.whitedune_note') }}</span>
                    </div>
                </div>
            </div>
                ...
                <div class="book_cnt ">
                    <form class="offer__bk" action="{{ route('reservation.store') }}" method="post">
                        ...
                        <div class="d-flex mb-3 align-items-center justify-content-between">
                            <span class="price_span">{{ __('messages.whitedune_price') }}</span>
