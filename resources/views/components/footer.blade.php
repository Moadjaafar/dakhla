<footer>
    ...
    <div class="right__footer">
        <div class="row w-100 mx-auto">
            <div class="col-lg-3 col-md-4 col-6 col__footer mb-5">
                <h4>{{ __('messages.key_b61541208db7fa7dba42c85224405911') }}</h4>
                <ul class="footer__list">
                    <li><a href="{{ route('about_us') }}">{{ __('messages.key_cf23ee279844016288ea1c076638f3be') }}</a></li>
                    <li><a href="{{ route('offers_lits') }}">{{ __('messages.key_24cc85476cb8ec1a03192f09231e742b') }}</a></li>
                    <li><a href="{{ route('blog') }}">{{ __('messages.key_be8df1f28c0abc85a0ed0c6860e5d832') }}</a></li>
                </ul>
            </div>
            <div class="col-lg-3 col-md-4 col-6 col__footer">
                <h4>{{ __('messages.key_f0fb2ced8aa0654a5f2ba7902d8883df') }}</h4>
                <ul class="footer__list">
                    <li><a href="{{ route('about_us') }}">{{ __('messages.key_483a5da192f46e3cfe8391d3ef234fc4') }}</a></li>
                    <li><a href="{{ route('contact_us') }}">{{ __('messages.key_02d4482d332e1aef3437cd61c9bcc624') }}</a></li>
                </ul>
            </div>
            <div class="col-lg-5 col-md-4 col-12 col__footer mb-3">
            ...
            <div class="col-12">
                <div class="d-lg-flex position__v2   justify-content-lg-between align-items-lg-end">
                    <p class="cpy_rights">{{ __('messages.key_0244f161e000fc5f33bf5672179b4ab5') }}</p>
