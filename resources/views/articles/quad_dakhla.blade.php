...
@section('content')
    ...
    <section class="reservation__cnt">
        <div class="container reservation__details px-5 py-4">
            ...
            <div class="mt-4">
                <h1 class="cr_color text-center p_max_xxl mx-auto blog_titlecss">{{ __('messages.titleblog31') }}</h1>
                    <img loading="lazy" src="assets/images/blog_three.png" class="my-lg-5 my-3 w-100" alt="Découvrez Dakhla en Demi-Journée : Une Excursion en 4x4 avec Chauffeur-Guide">
                    <p class="cr_color">{{ __('messages.descr31') }}</p>
                    <h2 class="cr_color">{{ __('messages.titleblog32') }}</h2>
                    <p class="cr_color">{{ __('messages.descr32') }}</p>
                    <h2 class="cr_color">{{ __('messages.titleblo33') }}</h2>
                    <p class="cr_color">{{ __('messages.descr33') }}</p>
                    <h2 class="cr_color">{{ __('messages.titleblog34') }}</h2>
                    <p class="cr_color">{{ __('messages.descr34') }}</p>
                    <h2 class="cr_color">{{ __('messages.titleblog35') }}</h2>
                    <p class="cr_color">{{ __('messages.descr35') }}</p>
                    <h2 class="cr_color">{{ __('messages.titleblog36') }}</h2>
                    <p class="cr_color">{{ __('messages.descr36') }}</p>
                    <h2 class="cr_color">{{ __('messages.titleblog37') }}</h2>
                    <p class="cr_color">{{ __('messages.descr37') }}</p>
            </div>
        </div>
    </section>
