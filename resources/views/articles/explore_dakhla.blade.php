...
@section('content')
    ...
    <section class="reservation__cnt">
        <div class="container reservation__details px-5 py-4">
            <div class="d-flex align-items-center justify-content-between">
                ...
                <div class="d-flex align-items-center gap-3">
                    ...
                    <div class="d-flex gap-2"> 
                        <a href=""><img loading="lazy" src="assets/images/facebook.svg" alt=""></a>
                        <a href=""><img loading="lazy" src="assets/images/facebook.svg" alt=""></a>
                        <a href=""><img loading="lazy" src="assets/images/facebook.svg" alt=""></a>
                    </div>
                </div>
            ...
            <div class="mt-4">
                <h1 class="cr_color text-center p_max_xxl mx-auto blog_titlecss">{{ __('messages.key_e965a394babb1430f067ce1b081194f7') }}</h1>
                <img loading="lazy" src="assets/images/readcump.jpg" class="my-lg-5 my-3 w-100" alt="">
                <p class="cr_color">{{ __('messages.key_ff3c61fb6169ef0c863dce89cfb45863') }}</p>
                <h2 class="cr_color">{{ __('messages.key_0fad0164d4242c70668a8adc1a02e3b2') }}</h2>
                <p class="cr_color">{{ __('messages.key_0a951055cbb421bf53319b432e5ad50e') }}</p>
                <h2 class="cr_color">{{ __('messages.key_df26a9c010fb2d85c7aa36b0091f7967') }}</h2>
                <p class="cr_color">{{ __('messages.key_72c4abd11931ca2f4cfcd89daddf18b6') }}</p>
                <h2 class="cr_color">{{ __('messages.key_1defc3633fc8554f1737f1d155c903e6') }}</h2>
                <p class="cr_color">{{ __('messages.key_fd9a7622d16f4230b6e1e2cabb936adb') }}</p>
                <h2 class="cr_color">{{ __('messages.key_8cc578b0671a31c70d71435fd04dad43') }}</h2>
                <p class="cr_color">{{ __('messages.key_627a8b71ac3fce1945fb4140cfaa72e7') }}</p>
                <h2 class="cr_color">{{ __('messages.key_3c48989b696aa53a9d6ee5ee944b1c3c') }}</h2>
                <p class="cr_color">{{ __('messages.key_7cc7abaeaa40d449317a6e77f8baf5e3') }}</p>
                <h2 class="cr_color">{{ __('messages.key_5cffb1b7e81f13d70ef4c69541283240') }}</h2>
                <p class="cr_color">{{ __('messages.key_96c4dc135d39d3e7fe8108680b135623') }}</p>
                <h2 class="cr_color">{{ __('messages.key_e9ac91edd169866c720ecc3dfb539e7a') }}</h2>
                <p class="cr_color">{{ __('messages.key_ddc2a41afacbbb90121c07ce4e4e3cad') }}</p>
            </div>
        </div>
    </section>
