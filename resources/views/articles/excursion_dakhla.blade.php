...
@section('content')
    ...
    <section class="reservation__cnt">
        <div class="container reservation__details px-5 py-4">
            ...
            <div class="mt-4">
                <h1 class="cr_color text-center p_max_xxl mx-auto blog_titlecss">{{ __('messages.titleblog21') }}</h1>
                <img loading="lazy" src="assets/images/blog_two.png" class="my-lg-5 my-3 w-100" alt="Découvrez Dakhla en Demi-Journée : Une Excursion en 4x4 avec Chauffeur-Guide">
                <p class="cr_color">{{ __('messages.descr21') }}</p>
                <h2 class="cr_color">{{ __('messages.titleblog22') }}</h2>
                <p class="cr_color">{{ __('messages.descr22') }}</p>
                <h2 class="cr_color">{{ __('messages.titleblog23') }}</h2>
                <p class="cr_color">{{ __('messages.descr23') }}</p>
                <h2 class="cr_color">{{ __('messages.titleblog24') }}</h2>
                <p class="cr_color">{{ __('messages.descr24') }}</p>
                <h2 class="cr_color">{{ __('messages.titleblog25') }}</h2>
                <p class="cr_color">{{ __('messages.descr25') }}</p>
                <h2 class="cr_color">{{ __('messages.titleblog26') }}</h2>
                <p class="cr_color">{{ __('messages.descr26') }}</p>
                <h2 class="cr_color">{{ __('messages.titleblog27') }}</h2>
                <p class="cr_color">{{ __('messages.descr27') }}</p>
                <h2 class="cr_color">{{ __('messages.titleblog28') }}</h2>
                <p class="cr_color">{{ __('messages.descr28') }}</p>
                <h2 class="cr_color">{{ __('messages.titleblog29') }}</h2>
                <p class="cr_color">{{ __('messages.descr29') }}</p>
                <h2 class="cr_color">{{ __('messages.titleblog210') }}</h2>
                <p class="cr_color">{{ __('messages.descr210') }}</p>
            </div>
        </div>
    </section>
